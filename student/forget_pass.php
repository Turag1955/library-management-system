...
if (isset($_POST['forget_submit'])) {
    ...
    $haspass = password_hash($student_password, PASSWORD_DEFAULT);

    $query = mysqli_query($conn, "UPDATE `student` SET `student_password` = '$haspass'  WHERE `student_username` =  '$student_username' ");
    if ($query) {
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group mt-md">
                                    <span class="input-with-icon">
                                        <input type="text" class="form-control" id="student_username" placeholder="Username" name="student_username" >
                                        <i class="fa fa-user"></i>
                                    </span>
                                </div>
                                <div class="form-group mt-md">
                                    <span class="input-with-icon">
                                        <input type="password" class="form-control" id="" placeholder="Reset Password" name="student_password">
                                        <i class="fa fa-key"></i>
                                    </span>
                                </div>
